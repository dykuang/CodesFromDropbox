function [error,CM]= ave_perform_plane_NN(k,m,n)
% function [train_std,test_std]= ave_perform_plane_NN(k,m)
% randomly form training and test set of fix size used for evaluating 
% the performance of extract feature.
...
% Data = importdata('pca_P_score.mat');
...
train = Data(ind_train,[1:k, end]);
test = Data(ind_test,[1:k,end]);
