function [PV,V,P_major,H_piece_sorted,H_piece_index, H_major, H,H_piece,Q1,Q_major]= DD_PCA(I0,I1,k,flag)
...
ith_component = [PV(1,major_part(i))*V(:,major_part(i)),...
    PV(2,major_part(i))*V(:,major_part(i))];

[Q1(:,:,i),P1a] = Flow_nu(I0,ith_component,N,n,alpha2);
